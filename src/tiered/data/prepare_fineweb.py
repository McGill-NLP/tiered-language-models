...
def main():
    ...
    # THIS EXACT CALL HASHES SECURELY TO THE 6-HOUR CACHE
    tokenized_ds = ds.map(
        tokenize_and_chunk,
        batched=True,
        batch_size=1000,
    ...
    print(f"Saving safely and sequentially without shuffling index to prevent OOM...")
    
    # Save with low process limit to guarantee safety against RAM issues
