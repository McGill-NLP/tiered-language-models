...
def parse_args():
    ...
    parser.add_argument("--wandb_project", type=str, default="tiered-language-models")
...
def train(args):
    ...
    # Reproducibility: keep model init and dropout RNG fixed across key-size sweeps.
    ...
    # Standard C = 6ND per pass; we do 2 passes (C1 + C2) per step
